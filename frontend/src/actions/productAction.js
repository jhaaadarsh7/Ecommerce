...
// In the getProduct action, add currentPage parameter
export const getProduct = (
  ...
  try {     
    ...
    let link = `/api/v1/products?keyword=${keyword}&price[gte]=${price[0]}&price[lte]=${price[1]}&page=${currentPage}`; // Add page parameter
...
export const getAdminProduct = () => async (dispatch) => {
  try {
    ...
    dispatch({
      ...
      payload: data.products, // Payload contains the products fetched from the server
    });
  } catch (error) {
    dispatch({
